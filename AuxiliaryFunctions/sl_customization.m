%% SL_CUSTOMIZATION
% This function file is used to add custom checks to the Model Advisor. The
% function has been initialised based on the The Math Works template.
...
%% Add Objectives
% In order to simplify the main function, adding additional objectives has
% been split off into a sub-function.
